...
|  | If an incorrect word is entered on game input, an incorrect message is displayed and hangman image updated | Guess incorrect letter | Passed: Incorrect message displayed and hangman image updated | ![Word incorrect screenshot](documentation/testing-files/defensive-programming/defensive-game-word-incorrect.png) |
